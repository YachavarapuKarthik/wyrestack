...
function CourseDashboard() {
    return (
        <>
            <NavBar />
            {/* <h1 >This is course dashaboard</h1> */}
            <div className="dash-container">
                <div className="dash-info">
                    ...
                    <div className="dash-right">
                        <div className="vidplay"><iframe width="560" height="315" src="https://www.youtube.com/embed/iSfrVNowJ9Y?si=UC6aa9RY-TXZD1tm" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>
                        <div className="vidinfo">
                            <p className="vidcap">Preview this course</p>
                            <span className="offprice">$249</span>
                            <span className="actprice">$549</span> 
                            <span className="off">84% off</span><br />
